...
# Fragen-Auftrag: Trassenplan lesen
...
1. Was zeigt ein Trassenplan? *(Richtig: Den Verlauf und die Lage einer Bahnstrecke (Lageplan und Hoehenplan))*
2. Was versteht man unter Kilometrierung? *(Richtig: Die fortlaufende Streckenkennzeichnung in Kilometern zur genauen Ortsangabe)*
3. Was zeigt der Laengsschnitt (Hoehenplan) einer Trasse? *(Richtig: Den Hoehenverlauf und die Neigungsverhaeltnisse der Strecke)*
4. Wozu dienen Kilometersteine bzw. Streckenkilometer-Angaben in der Praxis? *(Richtig: Zur eindeutigen Ortsbestimmung entlang der Bahnstrecke, z. B. fuer Bauarbeiten oder Stoerungen)*
5. Was wird im Lageplan einer Trasse dargestellt? *(Richtig: Der Streckenverlauf in der Draufsicht, inklusive Kurven und Geraden)*
