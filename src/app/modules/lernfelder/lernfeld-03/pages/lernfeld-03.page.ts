...
import { Lf03DataService } from '../services/lf03-data.service';

@Component({
  selector: 'app-lernfeld-03',
  templateUrl: './lernfeld-03.page.html',
  styleUrls: ['./lernfeld-03.page.scss'],
  standalone: false,
})
export class Lernfeld03Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf03DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 3'}`;
  }
}
