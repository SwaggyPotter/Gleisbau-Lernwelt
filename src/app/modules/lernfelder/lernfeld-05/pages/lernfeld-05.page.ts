...
import { Lf05DataService } from '../services/lf05-data.service';

@Component({
  selector: 'app-lernfeld-05',
  templateUrl: './lernfeld-05.page.html',
  styleUrls: ['./lernfeld-05.page.scss'],
  standalone: false,
})
export class Lernfeld05Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf05DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 5'}`;
  }
}
