...
import { Lf06DataService } from '../services/lf06-data.service';

@Component({
  selector: 'app-lernfeld-06',
  templateUrl: './lernfeld-06.page.html',
  styleUrls: ['./lernfeld-06.page.scss'],
  standalone: false,
})
export class Lernfeld06Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf06DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 6'}`;
  }
}
