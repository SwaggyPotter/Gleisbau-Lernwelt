...
import { Lf07DataService } from '../services/lf07-data.service';

@Component({
  selector: 'app-lernfeld-07',
  templateUrl: './lernfeld-07.page.html',
  styleUrls: ['./lernfeld-07.page.scss'],
  standalone: false,
})
export class Lernfeld07Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf07DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 7'}`;
  }
}
