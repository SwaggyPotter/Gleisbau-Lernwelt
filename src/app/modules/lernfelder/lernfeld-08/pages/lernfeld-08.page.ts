...
import { Lf08DataService } from '../services/lf08-data.service';

@Component({
  selector: 'app-lernfeld-08',
  templateUrl: './lernfeld-08.page.html',
  styleUrls: ['./lernfeld-08.page.scss'],
  standalone: false,
})
export class Lernfeld08Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf08DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 8'}`;
  }
}
