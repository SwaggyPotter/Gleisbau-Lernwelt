...
import { Lf09DataService } from '../services/lf09-data.service';

@Component({
  selector: 'app-lernfeld-09',
  templateUrl: './lernfeld-09.page.html',
  styleUrls: ['./lernfeld-09.page.scss'],
  standalone: false,
})
export class Lernfeld09Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf09DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 9'}`;
  }
}
