...
import { Lf10DataService } from '../services/lf10-data.service';

@Component({
  selector: 'app-lernfeld-10',
  templateUrl: './lernfeld-10.page.html',
  styleUrls: ['./lernfeld-10.page.scss'],
  standalone: false,
})
export class Lernfeld10Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf10DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 10'}`;
  }
}
