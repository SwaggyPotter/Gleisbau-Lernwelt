...
import { Lf11DataService } from '../services/lf11-data.service';

@Component({
  selector: 'app-lernfeld-11',
  templateUrl: './lernfeld-11.page.html',
  styleUrls: ['./lernfeld-11.page.scss'],
  standalone: false,
})
export class Lernfeld11Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf11DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 11'}`;
  }
}
