...
import { Lf13DataService } from '../services/lf13-data.service';

@Component({
  selector: 'app-lernfeld-13',
  templateUrl: './lernfeld-13.page.html',
  styleUrls: ['./lernfeld-13.page.scss'],
  standalone: false,
})
export class Lernfeld13Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf13DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 13'}`;
  }
}
