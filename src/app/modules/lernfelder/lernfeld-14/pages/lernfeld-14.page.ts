...
import { Lf14DataService } from '../services/lf14-data.service';

@Component({
  selector: 'app-lernfeld-14',
  templateUrl: './lernfeld-14.page.html',
  styleUrls: ['./lernfeld-14.page.scss'],
  standalone: false,
})
export class Lernfeld14Page implements OnInit, OnDestroy {
  ...
  constructor(
    private readonly data: Lf14DataService,
  ...
  get overallQuizTitle(): string {
    return `Gesamtquiz: ${this.quiz?.meta.title ?? 'Lernfeld 14'}`;
  }
}
