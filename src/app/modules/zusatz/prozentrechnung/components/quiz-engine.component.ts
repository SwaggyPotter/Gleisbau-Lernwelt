...
import { QuizQuestion } from '../models/prozentrechnung.models';

type AnswerState = { choice?: string; correct?: boolean };

@Component({
  selector: 'app-prozentrechnung-quiz-engine',
  templateUrl: './quiz-engine.component.html',
  styleUrls: ['./quiz-engine.component.scss'],
  standalone: false,
})
export class ProzentrechnungQuizEngineComponent implements OnChanges {
