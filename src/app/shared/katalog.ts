...
export const RECHENTRAINER_TILES: QuizTile[] = [
  ...
  {
    id: 'quiz-weichenrechner',
    title: 'Weichengeometrie-Rechner',
    description: 'Neigung, Weichenwinkel, Zungenlänge und überschlägige Weichenlänge selbst berechnen.',
    icon: 'git-network-outline',
    tag: 'Quiz',
    link: '/zusatz/weichenrechner',
    image: 'assets/bilder/weichenrechner-diagramm.svg',
    imageCredit: 'Eigene Grafik',
  },
  {
    id: 'quiz-schienendehnung',
    title: 'Schienenausdehnungs-Rechner',
    description: 'Thermische Längenänderung von Schienenstahl und Lückenschluss bei Erwärmung berechnen.',
    icon: 'thermometer-outline',
    tag: 'Quiz',
    link: '/zusatz/schienendehnung',
    image: 'assets/bilder/schienendehnung-diagramm.svg',
    imageCredit: 'Eigene Grafik',
  },
  {
    id: 'quiz-pruefungssimulation',
    title: 'Prüfungssimulation',
    description: 'Gemischtes Quiz über alle Lernfelder mit Timer, kein Sofort-Feedback — wie in einer echten Prüfung.',
    icon: 'timer-outline',
    tag: 'Quiz',
    link: '/zusatz/pruefungssimulation',
    image: 'assets/bilder/pruefungssimulation-diagramm.svg',
    imageCredit: 'Eigene Grafik',
  },
  {
    id: 'quiz-lernfortschritt',
    title: 'Lernfortschritt',
    description: 'Alle Module auf einen Blick — beantwortete Fragen, Trefferquote und Bestwerte.',
    icon: 'stats-chart-outline',
    tag: 'Uebersicht',
    link: '/zusatz/lernfortschritt',
    image: 'assets/bilder/lernfortschritt-diagramm.svg',
    imageCredit: 'Eigene Grafik',
  },
  {
    id: 'quiz-glossar',
    title: 'Fachbegriffe-Glossar',
    description: 'Über 50 Begriffe aus Oberbau, Trassierung, Weichen, Kleineisen und Arbeitssicherheit zum Nachschlagen.',
    icon: 'book-outline',
    tag: 'Uebersicht',
    link: '/zusatz/glossar',
...
export const SPIELE_TILES: QuizTile[] = [
  ...
  {
    id: 'spiel-baumaschinen',
    title: 'Baumaschinen erkennen',
    description: 'Stopfmaschine, Schienenschleifzug, Gleisbaukran und mehr am Foto erkennen.',
    tag: 'Spiel',
    icon: 'construct-outline',
    link: '/zusatz/baumaschinen',
    image: 'https://commons.wikimedia.org/wiki/Special:FilePath/01%20582%20SIG-Stopfmaschine.jpg?width=900',
    imageCredit: 'Falk2, CC BY-SA 3.0, via Wikimedia Commons',
  },
];
...
export const WISSENSTEST_TILES: QuizTile[] = [
    ...
    {
      id: 'themenquiz-arbeitssicherheit',
      title: 'Arbeitssicherheit im Gleisbereich',
      description: 'Selbstsicherung, Fremdsicherung, Raeumzeit, Gefahrenraum, Warnkleidung.',
      tag: 'Sicherheit',
      icon: 'shield-checkmark-outline',
      link: '/themenquiz/arbeitssicherheit',
      topicId: 'arbeitssicherheit',
      questionCount: 20,
      image: 'assets/bilder/arbeitssicherheit-diagramm.svg',
      imageCredit: 'Eigene Grafik',
    },
];
